"""
Data loader: IBM Marrakesh (Heron r2) via Qiskit Runtime.
"""
import json
import sys
...
csv_path = repo_root / "data" / "ibm_marrakesh" / "results.csv"
...
inc_path = repo_root / "incidents" / "ibm_marrakesh" / "incidents.csv"
