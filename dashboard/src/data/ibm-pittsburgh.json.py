"""
Data loader: IBM Pittsburgh (Heron r3) via Qiskit Runtime.
"""
import json
import sys
...
csv_path = repo_root / "data" / "ibm_pittsburgh" / "results.csv"
